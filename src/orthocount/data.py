...
def preprocess(cfg: DictConfig) -> None:
    ...
    #data_path: Path, output_folder: Path, 
    dcfg = cfg.datasets
    tcfg = cfg.tiling
    dataset = RFOrthophoto(geotiff_path=dcfg.geotiff_filepath, vector_path=dcfg.shape_filepath,im_size=tcfg.im_size,overlap=tcfg.overlap)
    dataset.preprocess()
    print(dataset)
